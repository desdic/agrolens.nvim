describe("glsl", function()
    ...
    it("functions", function()
        ...
        assert.equals("default.frag:26:0:vec4 pointLight()",
                      entries[1])
        assert.equals("default.frag:55:0:vec4 direcLight()",
                      entries[2])
        assert.equals("default.frag:75:0:vec4 spotLight()",
                      entries[3])
        assert.equals("default.frag:104:0:void main()", entries[4])
    end)
    it("callings", function()
        ...
        assert.equals(
            "default.frag:107:2:  FragColor = spotLight();",
            entries[1])
    end)
    it("comments", function()
        ...
        assert.equals("default.frag:3:0:// Outputs colors in RGBA",
                      entries[1])
        assert.equals(
            "default.frag:106:2:  /* outputs final color */",
            entries[23])
    end)
end)
