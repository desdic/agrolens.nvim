describe("toml", function()
    ...
    it("labels", function()
        ...
        assert.equals("test.toml:5:0:[owner]", entries[1])
        assert.equals("test.toml:9:0:[database]", entries[2])
        assert.equals("test.toml:15:0:[servers]", entries[3])
        assert.equals("test.toml:17:0:[servers.alpha]", entries[4])
        assert.equals("test.toml:21:0:[servers.beta]", entries[5])
    end)
end)
