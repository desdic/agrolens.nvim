describe("c", function()
    ...
    it("functions", function()
        ...
        assert.equals('tests/c/test.c:65:0:int main() {', entries[4])
    end)
    it("callings", function()
        ...
        assert.equals('tests/c/test.c:69:2:  strncpy(donald.name, "Donald Duck", MAXNAME);', entries[8])
        assert.equals('tests/c/test.c:70:2:  strncpy(donald.born, "07-09-1934", MAXDATE);', entries[9])
        assert.equals('tests/c/test.c:73:2:  print_person(&donald, basic_calc);', entries[10])
    end)
    it("comments", function()
        ...
        assert.equals('tests/c/test.c:67:2:  // Create Donald', entries[3])
        assert.equals('tests/c/test.c:72:2:  // Print Donald', entries[4])
    end)
