describe("make", function()
    ...
    it("labels", function()
        ...
        assert.equals("Makefile:1:0:.PHONY: all", entries[1])
        assert.equals("Makefile:3:0:all: lint test", entries[2])
        assert.equals("Makefile:5:0:test:", entries[3])
        assert.equals("Makefile:8:0:lint:", entries[4])
        assert.equals("Makefile:11:0:docgen:", entries[5])
    end)
end)
